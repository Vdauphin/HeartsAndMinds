...
if (_meme isEqualType true) then {
	...
	if (random < _meme) then { _arrayGrenades append ["SmokeShellGreen", "F_40mm_White", "O_IRStrobe", "R_230mm_HE",  "BombDemine_01_DummyAmmo_F",  "G_40mm_SmokePurple"] };
};
...
[_pos, 18] remoteExec ["cvo_ied_fnc_failedIED_fx", 0];
