...
<p align="center">
    <a href="https://github.com/Vdauphin/HeartsAndMinds/releases/tag/1.23.2">
        <img src="https://img.shields.io/badge/Version-1.23.2-blue.svg?style=flat-square" alt="H&M Version">
    </a>
...
A new formed group, known as "Insurgents", is against the NATO intervention and is ready to fight.

### :white_check_mark: Goal
Your main task is to defeat the "Insurgents" group and restore peace and order in Altis.
...
Infact there's a reputation system: helping the local population, fighting the "Insurgents", disarming IED will rise your reputation; killing civilians, mutilate alive/dead civilian, firing near civilians for no reason, remove Humanitarian Ration, damaging/destroying buildings, breaking locked door, losing vehicles, respawns will decrease your reputation.
At the beginning you have a very low reputation level, so civilians won't help you revealing important information about Insurgents, they will likely lie instead.
