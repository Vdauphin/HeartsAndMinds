...
private _array = [
    ...
    ['\A3\ui_f\data\igui\cfg\simpleTasks\types\whiteboard_ca.paa',  _color, (getPos cvo_jobboard), 1.1, 1.1, 0, "Job Board", 1],                                                                        //Job Board
    ['\A3\ui_f\data\igui\cfg\simpleTasks\types\rifle_ca.paa',       _color, (getPos CVO_Arsenal), 1.1, 1.1, 0, localize "STR_BTC_HAM_INTRO_ARSENAL", 1],                                       //Arsenal
